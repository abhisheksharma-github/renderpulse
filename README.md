...
**RenderPulse** solves this problem by sending non-blocking parallel health pings directly from your browser to all your services simultaneously, with a live 60-second countdown timer and real-time container status.
...
RenderPulse is a 100% client-side static web application and can be hosted for free anywhere:

### 1. GitHub Pages
1. Push your code to GitHub.
2. In your repo settings, navigate to **Pages** and set deployment source to **GitHub Actions** (or build and push `dist/` to `gh-pages` branch).
...
### 3. Netlify
Drag and drop your `dist/` folder into [Netlify Drop](https://app.netlify.com/drop).

### 4. Cloudflare Pages
Link your repository, set the build command to `npm run build`, and output folder to `dist`.
